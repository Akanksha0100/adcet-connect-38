...
const SettingsPage = () => (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 max-w-2xl">
    ...
    <div className="card-elevated p-6 space-y-5">
      <h2 className="text-lg font-semibold text-foreground flex items-center gap-2"><User className="h-4 w-4" /> Profile</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5 sm:col-span-2">
          ...
          <Input defaultValue="admin@adcet.edu.in" type="email" />
        </div>
      </div>
    ...
    {/* Preferences */}
    <div className="card-elevated p-6 space-y-5">
      <h2 className="text-lg font-semibold text-foreground flex items-center gap-2"><Shield className="h-4 w-4" /> Preferences</h2>
